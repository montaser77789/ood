...
export default function FieldsSection() {
  ...
  return (
    ...
    <div className="container">
        ...
        {/* Arrows */}
        <div className="flex justify-start gap-3 mb-6 mr-auto">
          <button
            ref={prevRef}
            className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center hover:bg-primary hover:text-white transition"
          >
            <ChevronRight />
          </button>
